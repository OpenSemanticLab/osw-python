...
Welcome to `osw` contributor's guide.
...
If you experience bugs or general issues with `osw`, please have a look
...
You can help improve `osw` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`osw` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `osw`'s files. While this mechanism can
...
```
conda create -n osw python=3 six virtualenv pytest pytest-cov
conda activate osw
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/osw.git
   cd osw
   ```
...
5. Install [pre-commit]:
   ...
   `osw` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/osw
[issue tracker]: https://github.com/<USERNAME>/osw/issues
