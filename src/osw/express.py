    ...
    def upload_file(
        ...
        **properties: Dict[str, Any],
        ...
        source
            ...
            str, Path or an open file-like object.
        url_or_title
...
class UploadFileResult(FileResult, WikiFileController):
    ...
    def __init__(
        ...
        **data: Dict[str, Any],
        ...
        # duck-typed: typing.IO is not runtime-checkable, isinstance(BytesIO(), IO)
        # is False, so an explicit isinstance check would never match a stream
